...
const Welcome = () => {
    ...
    return (
        <div className="h-[calc(100vh-50px)] min-h-[350px]  flex bg-brand-500  ">
            <div className="relative flex w-full justify-center items-center">
                <LazyImage className="object-scale-down w-[50vw] max-w-[400px] " src={!isDark ? '/assets/images/logo2.png' : '/assets/images/logo-white.png'} alt="maintenence" />
            </div>
            <div className="font-semibold dark:text-white">
                {/* <h2 className="text-3xl font-bold text-black lg:text-5xl xl:text-6xl">Welcome to Clear Eats</h2> */}
                <h4 className="mb-7 text-xl sm:text-2xl"></h4>
