...
const Fallback: FC<IFallbackProps> = ({ title }) => {
    return (
        <div className="">
            <div className=" p-6 py-3 border-b flex justify-between items-center">
                <h1 className="font-bold text-lg">{title}</h1>
                <Skeleton height={30} width={'80px'} />
            </div>
            <div className="px-5 py-2 ">
                <div className="flex justify-between items-center">
                    <h2 className=" text-md font-bold">{title + ' Listing'}</h2>
                    <div className=" flex gap-4 pointer-events-none opacity-40">
                        <button>
            ...
            <Skeleton className="rounded-none" height={300} mb="md" />
