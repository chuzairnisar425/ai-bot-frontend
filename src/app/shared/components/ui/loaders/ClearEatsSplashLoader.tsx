...
const defaultLayoutBg = '../../../../../../assets/brand-logos/clearEatsSplashBackground.png';
...
function ClearEatsSplashLoader({ show = true, loaderBgImage, loaderText, loading, className, backgroundColor, loaderLogo }: ILoaderProps): JSX.Element {
    ...
    return (
        <>
            ...
            >
                <div style={{ backgroundColor: `${backgroundColor}D1` }} className="screen_loader  fixed inset-0 bg-brand-500/85 dark:bg-[#060818] z-[60] grid place-content-center animate__animated">
                    {showLoader && (
                        <div className="flex flex-col justify-center items-center gap-2">
                            {loaderLogo && loaderLogo != 'null' ? (
                                ...
                                <LazyImage className="animate object-scale-down w-28" src="/assets/brand-logos/favicon-light.png" />
                            ) : null}
